  ...
  return (
    <section className="bg-bookmark-white py-20 mt-20 lg:mt-60">
      ...
      <div className="relative mt-20 lg:mt-24">
        ...
        {/* ROUNDED RECTANGLE */}
        <div
          className="hidden lg:block overflow-hidden bg-bookmark-purple rounded-r-full absolute h-80 
        w-2/4 -bottom-24 lg: -left-36"
        ></div>
      </div>
      {/* Feature 2 */}
      <div className="relative mt-20 lg:mt-52">
        ...
        {/* ROUNDED RECTANGLE */}
        <div
          className="hidden lg:block overflow-hidden bg-bookmark-purple rounded-l-full absolute h-80 
        w-2/4 -bottom-24 lg: -right-36"
        ></div>
      </div>
      {/* Feature 3 */}
      <div className="relative mt-20 lg:mt-52">
